    ...
    S.prototype = {
        ...
        preventDefaults: function(a) {
            if (!_b) {
                ...
                if (!g || !f)
                    return e || f && c & Jb || g && c & Kb ? this.preventSrc(b) : void 0
            }
        },
    ...
    U.prototype = {
        ...
        canEmit: function() {
            for (var a = 0; a < this.requireFail.length;) {
                if (!(this.requireFail[a].state & (mc | gc)))
                    return !1;
                a++
            }
            return !0
        ...
        process: function(a) {
            ...
            if (this._input = a, !d || !c || a.eventType & (Cb | Db) && !f)
                this.reset();
            else if (a.eventType & Ab)
                this.reset(), this._timer = e(function() {
                    this.state = kc, this.tryEmit()
                }, b.time, this);
            else if (a.eventType & Cb)
                return kc;
            return mc
        },
        reset: function() {
        ...
        process: function(a) {
            var b = this.options,
                ...
                d = a.distance < b.threshold,
                f = a.deltaTime < b.time;
            if (this.reset(), a.eventType & Ab && 0 === this.count)
